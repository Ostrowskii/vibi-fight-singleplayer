...
const __STORY_SKILLS = {
  ...
  2: {name: "Me2", classLabel: "Melee", customDescription: "", legends: ["A"], damage: 10, pull: 0, cost: 520},
  3: {name: "Me3", classLabel: "Melee", customDescription: "", legends: ["A"], damage: 10, pull: 0, cost: 560},
  4: {name: "Me4", classLabel: "Melee", customDescription: "", legends: ["A"], damage: 10, pull: 0, cost: 920},
  5: {name: "Ma1", classLabel: "Mage", customDescription: "", legends: ["P", "I"], damage: 0, pull: 0, cost: 680},
  6: {name: "Ma2", classLabel: "Mage", customDescription: "", legends: ["P", "F"], damage: 0, pull: 0, cost: 2200},
  7: {name: "Me5", classLabel: "Melee", customDescription: "", legends: ["H"], damage: 0, pull: 2, cost: 380},
  8: {name: "Ra1", classLabel: "Ranged", customDescription: "", legends: ["P", "D"], damage: 10, pull: 0, cost: 3000},
  9: {name: "Ma3", classLabel: "Mage", customDescription: "", legends: ["P", "I"], damage: 0, pull: 0, cost: 1200},
  10: {name: "Ra2", classLabel: "Ranged", customDescription: "", legends: ["P", "D"], damage: 10, pull: 0, cost: 820},
  11: {name: "Ra3", classLabel: "Ranged", customDescription: "", legends: ["P", "D"], damage: 10, pull: 0, cost: 2600},
  12: {name: "Ra4", classLabel: "Ranged", customDescription: "", legends: ["P", "D"], damage: 10, pull: 0, cost: 300},
  13: {name: "Ra5", classLabel: "Ranged", customDescription: "", legends: ["P", "D"], damage: 10, pull: 0, cost: 340},
  14: {name: "Me6", classLabel: "Melee", customDescription: "", legends: ["P", "D", "H"], damage: 10, pull: 4, cost: 180},
  15: {name: "Me7", classLabel: "Melee", customDescription: "", legends: ["A"], damage: 10, pull: 0, cost: 220},
};
...
function __story_campaign_bot_loadout(level) {
  switch (level >>> 0) {
    case 2: return {s1: 14, s2: 1, s3: 0};
    case 3: return {s1: 15, s2: 12, s3: 0};
    case 4: return {s1: 1, s2: 13, s3: 0};
    case 5: return {s1: 2, s2: 3, s3: 7};
    case 6: return {s1: 2, s2: 10, s3: 5};
    case 7: return {s1: 3, s2: 4, s3: 9};
    case 8: return {s1: 4, s2: 10, s3: 7};
    case 9: return {s1: 4, s2: 6, s3: 5};
    case 10: return {s1: 2, s2: 10, s3: 11};
    case 11: return {s1: 4, s2: 6, s3: 11};
